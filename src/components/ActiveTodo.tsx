...
type Props = {
	...
	handleUpdateButton: (todo: Todo) => void;
};
	...
	return (
		<main className='relative flex w-6/12 min-w-[550px] flex-col gap-10 bg-slate-300 p-10'>
			{isSelectedTodo.id ? (
				...
				<p className='flex h-full items-center justify-center overflow-scroll whitespace-pre-wrap rounded-lg bg-slate-200 p-3 text-2xl text-slate-400'>
					選択されたノートはありません。
				</p>
			)}
